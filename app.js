...
function initAmapModule() {
  ...
  const points = [
    { id: 1, name: '阿勒泰雪都机场', lng: 88.114, lat: 47.751, tag: '接送机汇合点', desc: '距市区12km，全天接机，福特T6专车接送。' },
    { id: 2, name: '阿勒泰市福朋喜来登酒店', lng: 88.138, lat: 47.846, tag: '第1/5晚住宿', desc: '五星级高星连锁，城景双床房，全天候地暖。' },
    { id: 3, name: '阿禾景观公路', lng: 87.802, lat: 48.008, tag: '北疆小独库', desc: '全长209.45km串联31处观景台，雪山、森林、草原大片。' },
    { id: 4, name: '禾木塞尚艺术民宿', lng: 87.435, lat: 48.562, tag: '第2晚住宿', desc: '图瓦木屋，哈登平台看夕阳晨雾与篝火银河。' },
    { id: 5, name: '深山见·山野如许(白哈巴老村)', lng: 86.782, lat: 48.694, tag: '第3晚住宿', desc: '西北第一村，5号界碑、界河、哨所与国境落日。' },
    { id: 6, name: '卧湖·临湖观雪山民宿(喀纳斯湖)', lng: 87.031, lat: 48.718, tag: '第4晚住宿', desc: '神仙湾/月亮湾/卧龙湾徒步，临湖观雪山日落。' },
    { id: 7, name: '布尔津五彩滩景区', lng: 86.848, lat: 47.785, tag: 'D5落日雅丹', desc: '额尔齐斯河两岸雅丹与林海对望，17:30-19:30 黄金色彩。' }
  ];
